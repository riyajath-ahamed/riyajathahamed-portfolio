    ...
    <div className="relative w-screen h-screen overflow-hidden bg-background select-none">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-3 pt-3 gap-2">
        ...
        <div className="hidden sm:flex gap-2">
          <Link href="/game" className="px-4 py-2 bg-card text-card-foreground border border-border rounded-lg shadow-sm hover:bg-accent hover:text-accent-foreground text-sm font-medium">Games</Link>
        ...
        <div className="flex sm:hidden mt-20 gap-2">
          <Link href="/game" className="h-10 px-2.5 bg-card text-card-foreground border border-border rounded-lg shadow-sm flex items-center justify-center text-xs font-medium">Games</Link>
